    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('new', 'New'), ('working', 'Working'), ('qualified', 'Qualified'), ('unqualified', 'Unqualified'), ('on hold', 'On Hold')], max_length=255, null=True, verbose_name='Status of Lead')),
                ...
                ('salutation', models.CharField(blank=True, choices=[('Mr', 'Mr'), ('Ms', 'Ms'), ('Mrs', 'Mrs'), ('Dr', 'Dr'), ('Prof', 'Prof')], max_length=10, null=True)),
                ('department', models.CharField(choices=[('Sales', 'Sales'), ('Marketing', 'Marketing'), ('Support', 'Support'), ('Finance', 'Finance'), ('Operations', 'Operations')], default='Sales', max_length=50)),
                ('preferred_language', models.CharField(choices=[('English', 'English'), ('Dutch', 'Dutch'), ('Arabic', 'Arabic'), ('German', 'German'), ('French', 'French'), ('Spanish', 'Spanish')], default='English', max_length=50)),
                ('rating', models.CharField(blank=True, choices=[('Hot', 'Hot'), ('Warm', 'Warm'), ('Cold', 'Cold')], max_length=10, null=True)),
                ('budget_range', models.CharField(blank=True, choices=[('less_than_5000', 'Less than €5,000'), ('5000_to_10000', '€5,000–€10,000'), ('10000_to_25000', '€10,000–€25,000'), ('over_25000', 'Over €25,000')], max_length=50, null=True)),
                ('decision_timeframe', models.CharField(blank=True, choices=[('within_1_week', 'Within 1 week'), ('within_1_month', 'Within 1 month'), ('within_3_months', 'Within 3 months'), ('more_than_3_months', 'More than 3 months')], max_length=50, null=True)),
