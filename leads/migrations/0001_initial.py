    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget_range', models.CharField(blank=True, choices=[('less_5k', 'Less than €5,000'), ('5k_10k', '€5,000–€10,000'), ('10k_25k', '€10,000–€25,000'), ('over_25k', 'Over €25,000')], max_length=50, null=True)),
                ('decision_timeframe', models.CharField(blank=True, choices=[('1_week', 'Within 1 week'), ('1_month', 'Within 1 month'), ('3_months', 'Within 3 months'), ('more_3_months', 'More than 3 months')], max_length=50, null=True)),
